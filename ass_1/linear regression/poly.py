...
def design_matrix(x, degree):
    ...
    # TODO
    #
    # Return the numpy array of shape (N,degree+1)a)
    ...
    X = np.power(np.kron(x,np.ones(degree+1)),np.arange(degree+1.))
...
def compute_error(theta, degree, x, y):
    ...
    err = (1/x.shape[0])*np.linalg.norm(err_vec)**2 # TODO: Change me
    #
    # END TODO
    ######################
